...
saveRDS(rasch_models, "scripts/hrtl/hrtl_rasch_models.rds")
saveRDS(conversion_tables, "scripts/hrtl/hrtl_conversion_tables.rds")
saveRDS(model_diagnostics, "scripts/hrtl/hrtl_model_diagnostics.rds")
